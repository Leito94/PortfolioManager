...
for ticker in all_tickers[100:2000]:
    try:
...
fundamental_EBIT.to_csv("fundamentals_EBIT.csv")
fundamental_AT.to_csv("fundamentals_AT.csv")
adjusted_close_price_data.to_csv("stock_price_data.csv")
mar_cap_df.to_csv("mar_cap.csv")
